========================================================================
    콘솔 응용 프로그램 : EchoServerClient 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 EchoServerClient 응용 프로그램을 만들었습니다.

EchoServerClient 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


EchoServerClient.vcxproj
...
EchoServerClient.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 EchoServerClient.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
