========================================================================
    콘솔 응용 프로그램 : SolutionForStudy 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 SolutionForStudy 응용 프로그램을 만들었습니다.

SolutionForStudy 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


SolutionForStudy.vcxproj
...
SolutionForStudy.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 SolutionForStudy.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
